...
***Ask not what IntelliNote can do for you - ask what you can do for IntelliNote***
...
2. Include additional information such as:
    ...
    * IntelliNote Debug-Info containing:
...
1. Respect existing IntelliNote coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
